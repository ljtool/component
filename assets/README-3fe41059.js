import{o as a,a as l,z as n}from"./vue-libs-d2aebc66.js";const t={class:"van-doc-markdown-body"},c=n(`<h1>scrollX PC 鼠标横向滑动 scroll</h1><div class="van-doc-card"><h3 id="jie-shao" tabindex="-1">介绍</h3><p>scrollX PC 鼠标横向滑动 scroll</p></div><div class="van-doc-card"><h3 id="yin-ru" tabindex="-1">引入</h3><pre><code class="language-js"><span class="hljs-keyword">import</span> scrollX <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;lj-utils/directives/scrollX&#39;</span>;
...
</code></pre></div>`,5),p=[c],h={__name:"README",setup(o,{expose:s}){return s({frontmatter:{}}),(e,d)=>(a(),l("div",t,p))}};export{h as default};
